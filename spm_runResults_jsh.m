function spm_runResults_jsh(stats_dir, multiple, thresh)
...
results.matlabbatch{1}.spm.stats.results.conspec.threshdesc = multiple;
results.matlabbatch{1}.spm.stats.results.conspec.thresh = thresh;
